<?php
include '../../controller/UserController/show.php';
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <form action="../../controller/UserController/update.php" method="POST">
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="custom-control custom-radio ml-5">
                                <input class="custom-control-input" value="0" type="radio" id="active" name="role" <?php echo $role == 0 ? 'checked' : '' ?>>
                                <label for="active" class="custom-control-label">Có</label>
                            </div>
                            <div class="custom-control custom-radio ml-5">
                                <input class="custom-control-input" value="1" type="radio" id="no_active" name="role" <?php echo $role == 1 ? 'checked' : '' ?>>
